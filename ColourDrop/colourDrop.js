var stage;
var shapes = [];    //  Blocks to be dragged
var slots = [];     //  Slots to drop blocks in
var score = 0;
...
function buildShapes(){
    ...
    for (i = 0; i < colours.length; i++){
        ...
        slot.graphics.beginStroke(colours[i]);
...
function startDrag(e){
    ...
    stage.addEventListener('stagemouseup', function(e){
        stage.removeAllEventListeners();    //  Remove listeners to prevent the shape from following the mouse
